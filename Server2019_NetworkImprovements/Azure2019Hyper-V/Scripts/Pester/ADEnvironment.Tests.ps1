...
Describe 'Test AD Environment Tests' {
    ...
    Context 'Applications' {
        ...
        IT 'NetworkController is installed' {
            get-windowsfeature RSAT-NetworkController | % installstate | should be 'Installed'
        }
        
        IT 'hyper-v is installed' {
            get-windowsfeature hyper-v | % installstate | should be 'Installed'
        }
        
        IT 'RSAT-Hyper-V-Tools is installed' {
            get-windowsfeature RSAT-Hyper-V-Tools | % installstate | should be 'Installed'
        }
        
        IT 'RSAT-Hyper-V-Tools is installed' {
            get-windowsfeature Hyper-V-PowerShell | % installstate | should be 'Installed'
        }
